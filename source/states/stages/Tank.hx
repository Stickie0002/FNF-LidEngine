...
class Tank extends BaseStage
{
    ...
    function ughIntro()
    {
        ...
        cutsceneHandler.timer(0.1, function() { wellWellWell.play(true); });
        cutsceneHandler.timer(3, function() { camFollow.x += 750; camFollow.y += 100; });
    ...
    function gunsIntro()
    {
        ...
        cutsceneHandler.timer(4, function() {
            ...
            gf.animation.finishCallback = function(name:String) { gf.playAnim('sad', true); };
        });
    }
    ...
    function stressIntro()
    {
        ...
        cutsceneHandler.onStart = function() { cutsceneSnd.play(true); };

        cutsceneHandler.timer(15.2, function() {
            FlxTween.tween(camFollow, {x: 650, y: 300}, 1, {ease: FlxEase.sineOut});
            pico.anim.play('dieBitch', true);
            
            // FIXED CALLBACK HANDSHAKE
        ...
        cutsceneHandler.timer(17.5, function() { zoomBack(); });
        cutsceneHandler.timer(19.5, function() { tankman.anim.play('lookWhoItIs', true); });
        cutsceneHandler.timer(31.2, function() { boyfriend.playAnim('singUPmiss', true); });
        cutsceneHandler.timer(32.2, function() { zoomBack(); });
    }
