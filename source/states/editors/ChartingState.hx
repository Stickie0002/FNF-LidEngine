...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Window Move', "Moves the game window to a specific desktop position.\nValue 1: X Coordinate (e.g. 500)\nValue 2: Y Coordinate (e.g. 300)"],
		['Window Scale', "Changes the physical size of the game window.\nValue 1: Scale (1.0 = Default, 0.5 = Half, 2.0 = Double)\nValue 2: Time to reach size (Seconds)"],
		['Window Shake', "Value 1: Intensity (Pixels), Value 2: Duration (Seconds)"],
		['Window Jump', "Makes the game window 'hop' on the desktop.\nValue 1: Jump Height (Pixels)\nValue 2: Jump Speed/Duration"],
		['Window Glitch', "The ultimate freak-out mode. Stretches, jumps, and glitches the window.\nValue 1: 'on' or 'off'\nValue 2: Glide back duration on stop."],
		['Fake UI', "Changes the text on the screen.\nValue 1: What to change (score, misses, time, or all)\nValue 2: The NEW words/numbers you want to show (Leave blank to reset to normal)"]
	];
...
class AttachedFlxText extends FlxText
{
	...
	override function update(elapsed:Float)
	{
		...
		// Previewing the window move in the editor
		if (FlxG.keys.justPressed.P) { // Press P to test the window position
			lime.app.Application.current.window.x += 10;
